...
def level1():
    ...
    while done:
        ...
        if Bumps.IntersectPlayer(Data.playerArrow.x, Data.enemy.x, Data.playerArrow.y, Data.enemy.y, 5, 40) == True:
        ...
        Data.info_string.blit(Data.label_font.render(u'Blocks ' + str(Data1.arrowCounter), 1, (210, 120, 200)), (150, 5))
        ...
        if Data.enemy.health <= 0:
            ...
            end_puncts_win = [(220, 40, u'Congratulations!Victory! ', (250, 250, 30), (250, 30, 250), 0),
                              (250, 100, u'Your score is ' + str(round(Data1.score, 2)), (250, 250, 30),(250, 30, 250),1),
