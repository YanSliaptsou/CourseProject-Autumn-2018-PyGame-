...
def level3():
    ...
    while done:
        ...
        if Bumps.IntersectPlayer(Data.playerArrow.x, Data.enemy2.x, Data.playerArrow.y, Data.enemy2.y, 10, 35) == True:
            Data.enemyArrow.x = Data.enemy.x
            Data.enemyArrow.y = Data.enemy.y
            Data.enemy.push = True
        ...
        if Bumps.IntersectEnemy(Data.enemy2Arrow.x, Data.hero.x, Data.enemy2Arrow.y, Data.hero.y, 10, 35) == True:
            Data.enemy2.push = False
            Data3.score -= 2
            Data.hero.health -= 5
            Data.enemy2.health += 5
        ...
        Data.info_string.blit(Data.speed_font.render(u'Speed: ' + str(round(Data.enemy.step + Data.enemy2.step, 2)), 1, (210, 120, 200)), (280, 5))
        Data.info_string.blit(Data.label_font.render(u'Blocks ' + str(Data3.arrowCounter), 1, (210, 120, 200)), (150, 5))
        ...
        Data.info_string.blit(Data.hero_health_font.render(u'Enemy health: ' + str(Data.enemy.health + Data.enemy2.health), 1, (0, 250, 200)), (600, 5))
        ...
        if Data.enemy.health <= 0:
            ...
            end_puncts_win = [(80, 40, u'Congratulations!You completed the game!', (250, 250, 30), (250, 30, 250), 0),
                              (250, 100, u'Your score is ' + str(round(Data3.score, 2)), (250, 250, 30), (250, 30, 250),1),
