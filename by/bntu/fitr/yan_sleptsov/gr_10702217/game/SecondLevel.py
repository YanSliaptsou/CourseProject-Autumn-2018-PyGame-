...
def level2():
    ...
    while done:
        ...
        Data.info_string.blit(Data.speed_font.render(u'Speed: ' + str(round(Data.enemy.step, 2)), 1, (210, 120, 200)),
                              (280, 5))
        Data.info_string.blit(Data.label_font.render(u'Blocks ' + str(Data2.arrowCounter), 1, (210, 120, 200)),
                              (150, 5))
        ...
        if Data.enemy.health <= 0:
            ...
            end_puncts_win = [(220, 40, u'Congratulations!Victory! ', (250, 250, 30), (250, 30, 250), 0),
                              (250, 100, u'Your score is ' + str(round(Data2.score, 2)), (250, 250, 30), (250, 30, 250),
                               1),
